...
#define CYAML_REGION_CONDITION_SPEC_SEDIMENT_FIELDS \
    ...
    CYAML_FIELD_STRING("c3", CYAML_FLAG_OPTIONAL, RDyRegionConditionSpec, sediment[3], 0), \
    CYAML_FIELD_STRING("c4", CYAML_FLAG_OPTIONAL, RDyRegionConditionSpec, sediment[4], 0), \
